...
package com.example.administrator.myapplication.Utils.Vuforia;
...
public class VuforiaAppSession implements UpdateCallbackInterface
{
    ...
    private vuforiaInterface mSessionControl;
    ...
    public VuforiaAppSession(vuforiaInterface sessionControl)
    {
    ...
    {
        AppExceptions vuforiaException = null;
        mActivity = activity;
        ...
        // VuforiaAppSession needs to update the Projection Matrix.
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new AppExceptions(
                AppExceptions.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            catch (Exception e)
            {
                ...
                vuforiaException = new AppExceptions(
                    AppExceptions.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    private void startCameraAndTrackers(int camera) throws AppExceptions
    {
        String error;
        if(mCameraRunning)
        {
            ...
            throw new AppExceptions(
                AppExceptions.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void startAR(int camera)
    {
        ...
        catch (Exception e)
        {
            ...
            vuforiaException = new AppExceptions(
                    AppExceptions.CAMERA_INITIALIZATION_FAILURE,
                    logMessage);
            Log.e(LOGTAG, logMessage);
        }
    ...
    public void stopAR() throws AppExceptions
    {
        ...
        synchronized (mLifecycleLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new AppExceptions(
                    AppExceptions.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new AppExceptions(
                    AppExceptions.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void pauseAR() throws AppExceptions
    {
        if (mStarted)
        {
            stopCamera();
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "" );
                do
                {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                catch (Exception e)
                {
                    ...
                    vuforiaException = new AppExceptions(
                            AppExceptions.TRACKERS_INITIALIZATION_FAILURE,
                            logMessage);
                    Log.e(LOGTAG, logMessage);
                }
            } else
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                catch (Exception e)
                {
                    ...
                    vuforiaException = new AppExceptions(
                            AppExceptions.LOADING_TRACKERS_FAILURE,
                            logMessage);
                }
            }
            else
